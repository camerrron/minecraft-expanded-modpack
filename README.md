...
Version **1.12.0** - 105 mods total. Built for Minecraft 1.21.1, Fabric loader 0.19.5.

## How to install

1. Go to the [latest release](../../releases/latest).
2. Under **Assets**, download **`minecraft-expanded-modpack-v1.12.0.zip`** specifically.
...
| ChestProtection | Locks chests or creates a trading chest! | [modrinth.com](https://modrinth.com/mod/chestprotection) |
...
| Fast Travel Waypoints |  | [www.curseforge.com](https://www.curseforge.com/projects/1492203) |
