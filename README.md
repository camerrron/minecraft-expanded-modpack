...
Version **1.10.5** - 101 mods total. Built for Minecraft 1.21.1, Fabric loader 0.19.5.

## How to install

1. Go to the [latest release](../../releases/latest).
2. Under **Assets**, download **`minecraft-expanded-modpack-v1.10.5.zip`** specifically.
